...
///
/// Warnings
/// - '*' as the width argument is not yet implemented
/// - "%%" will be the only accepted way to print a literal '%', i.e. "%-03l%" will not be allowed!
/// - Due to the host-platform dependence on the size of long-integers, %ld & %lu will not be allowed!
/// - Due to the host-platform dependence on wide-chars, %lc & %ls will not be allowed!
#[proc_macro]
